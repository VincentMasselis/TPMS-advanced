...
@SingleInstance
public class BluetoothLeScanner @Inject internal constructor() {
    ...
    public fun highDutyScan(): Flow<Tyre> = lowLatencyScanFlow

    @SuppressLint("MissingPermission")
    private val balancedScanFlow = scan(ScanSettings.SCAN_MODE_BALANCED).shared()

    public fun normalScan(): Flow<Tyre> = balancedScanFlow
